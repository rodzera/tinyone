...
const preBuild = gulp.series(clean, scaffold);
const build = gulp.parallel(scriptsDeploy, stylesDeploy, imagesDeploy);
exports.build = gulp.series(preBuild, build, htmlDeploy);
